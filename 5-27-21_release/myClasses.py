...
#Button, CheckBox, TextBox, InputBox, ToolBox, Runway
...
class Runway(object):
    ...
    def __init__(self):
        ...
        self.position = (0, 5, 0)
        self.color = (50, 50, 50)
        p1 = (self.position[0] - self.xSize/2, self.position[1] - self.ySize/2, 0)
        p2 = (self.position[0] - self.xSize/2, self.position[1], 0)
        p3 = (self.position[0] - self.xSize/2, self.position[1] + self.ySize/2, 0)
        p4 = (self.position[0], self.position[1] + self.ySize/2, 0)
        p5 = (self.position[0] + self.xSize/2, self.position[1] + self.ySize/2, 0)
        p6 = (self.position[0] + self.xSize/2, self.position[1], 0)
        p7 = (self.position[0] + self.xSize/2, self.position[1] - self.ySize/2, 0)
        p8 = (self.position[0], self.position[1] - self.ySize/2, 0)
        self.points = (p1, p2, p3, p4, p5, p6, p7, p8)
     
    #Draws the runway
    def draw(self, mode, canvas):       
        drawGroundRectangle(mode, canvas, self.points, self.color, 6)
