...
class TakeOff(ModalApp):
    def appStarted(app):
        ...
        app.planeSelectionMode = PlaneSelectionMode()
    ...
    def initializeInputVariables(app):
        ...
        app.inputBoxVars["cloudCount"] = 8
        app.inputBoxVars["bushCount"] = 50
        app.inputBoxVars["treeCount"] = 200
        app.inputBoxVars["viewRange"] = 155
        app.inputBoxVars["grassSize"] = 40
        ...
        app.inputBoxVars["accurateShadow"] = True
        app.inputBoxVars["mapSize"] = 500
        ...
        app.inputBoxVars["aircraftNumber"] = 1
        app.inputBoxVars["bodyRed"] = 255
        app.inputBoxVars["bodyGreen"] = 0
        app.inputBoxVars["bodyBlue"] = 0
        app.inputBoxVars["wingRed"] = 255
        app.inputBoxVars["wingGreen"] = 255
        app.inputBoxVars["wingBlue"] = 0


#Runs the game
TakeOff(width=1520, height=855)
