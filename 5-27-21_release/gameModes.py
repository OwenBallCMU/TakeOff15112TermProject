...
class GameMode(Mode):
    ...
    def timerFired(mode):
        ...
        if distance(mode.app.airplane.center, (0, 0, 0)) >= mode.app.inputBoxVars["mapSize"] * 1.2:
            mode.app.airplane.reset(mode)
    ...
    #Displays a message telling the user to turn the aircraft around
    ...
    def redrawAll(mode, canvas):
        ...
        if distance(mode.app.airplane.center, (0, 0, 0)) >= mode.app.inputBoxVars["mapSize"]:
...
class SettingsMode(Mode):
    ...
    def getSettingsData(mode):
        ...
        #Controls the options visible on the settings screen
        graphicsData = [
        ...
        ["checkBox", "Accurate Shadow", "accurateShadow"]
        ]
...
#Creates a screen where the user can select which aircraft they want to fly
class PlaneSelectionMode(Mode):
    ...
    #Creates the buttons that will be displayed on the selection screen
    def createButtons(mode):
        data = [
        ...
        #Creates the color selection input boxes
    ...
    #Selects the top-mounted wing airplane
    def switchToTopMounted(mode, _):
        mode.app.inputBoxVars["aircraftNumber"] = 1
        mode.activateNewPlane()

    #Selects one of the bottom-mounted wing airplanes
...
class SplashScreenMode(Mode):
    ...
    def createButtonsAndText(mode):
        ...
        subtitleText = TextBox(((subtitleX - subtitleWidth/2, subtitleY - subtitleHeight/2), 
                                  ...
                                  "an RC Aircraft Simulator by Owen Ball", CENTER, "white", "fixedsys")
