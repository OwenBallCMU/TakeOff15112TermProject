...
-A quadcopter model has been added. This model's "follow mode" is an FPV camera.
	-Training is not functional for the quadcopter
-Tree model and shadows improved
-Accurate shadows have been added for the aircraft. Disable for better performance
-Map size is customizable. Decrease along with trees and bushes to improve performance
###############
